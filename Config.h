...
#define SLEW_ACCELERATION_DIST        5 //    5.0, n, (degrees.) Approx. distance for acceleration (and deceleration.)      Adjust
...
#define AXIS1_STEPS_PER_DEGREE    12698.41270 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
#define AXIS1_STEPS_PER_WORMROT         45714 //      0, n. Number steps per worm rotation (PEC Eq mode only, 0 disables PEC.)   <-Req'd
...
#define AXIS2_STEPS_PER_DEGREE    12698.41270 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
